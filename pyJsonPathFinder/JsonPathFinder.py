...
def my_t_01():
    ...
    print(isinstance(json_t,(dict,list)))

    print (json_t)
    print (get_nestdict_value("0.id", json_t))
    print (get_nestdict_value("0.vpc_info.id", json_t))
    print (get_nestdict_value("0.vpc_info.project.id", json_t))
    print (json_t[0]["id"])
...
def my_t_02():
    ...
    #my_bytes_00 = (my_bytes, encoding='utf-8')
